...
<div class="container situation_probleme">
    ...
    <form action="#" method="post">
        <div class="text-center col-md-12 justify-content-center row mt-5 ">
            <div class="col-md-8 border border-info mr-2 mt-1">
                {!!__($cour->situation_probleme->contexte)!!}
            </div>  
            <div class="col-md-9 row mt-4">
                @php ($nbqst=1)
                @foreach ($cour->situation_probleme->question->sortBy('numero_qst') as $question)
    ...
    <div class="col-md-12 row text-md-right justify-content-center mb-0 mt-1 {{__('suivant')}}">
        <div class="col-md-6 offset-md-4 mb-4">
            <a href="{{ route('affiche.cours.TE')}}" class="btn btn-primary">
                {{ __('Trace Ecrite') }}
            </a>
        </div>
    </div>              
