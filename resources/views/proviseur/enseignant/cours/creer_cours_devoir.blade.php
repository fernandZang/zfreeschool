...
<div class="container">
    <div class="bg-olive row font-weight-bold text-center ">
        ...
        <div class="col border-right border-red p-2 bg-gradient-green">Devoir </div>
    </div>
            ...
            <div class="m-2">
                ...
                <div class="col-md-12 p-0 m-0">
                    <div class="row col-md-12 p-0 m-0">
                        <form class="m-0 p-0" method="POST" action="{{route('matiere.niveau.cours')}}">
                            @csrf
                            <div id="nbr"></div>
                            <div class="form-group col-md-11 ml-4">    
                                <input type="text" hidden name="cour_id" value={{ __($cour->id) }}>                                                    
                                <div class="col-md-11 ml-5 mr-0">
                                    <textarea class="contexte" name="contexte_devoir" autofocus></textarea>                                
                                </div>
                                <div class="mb-1 mt-1 text-right pr-5 add_devoir_question"><a href="#" class="btn btn-info p-1 m-1">ajouter les questions</a></div>
                            </div>
                            <div class="mt-2 row question">
                                <div class="col-md-6 col card-body border p-0 mb-0" >
                                    ...
                                    <div class="card-body m-0 p-0 mt-3">
                                        ...
                                        <div class="mb-1 mt-1 text-right pr-5 add_devoir_qro" id="QRO_contenant_link"><a href="#QRO_contenant_link" class="btn btn-info p-1 m-1"> ajouter QRO</a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col card-body border p-0 mb-0">
                                    ...
                                    <div class="card-body m-0 mt-3 p-0">
                                        ...
                                        <div>
                                            <div class="mb-1 mt-1 text-right pr-5 add_devoir_qru" id="QRU_contenant_link">
...
<script type="text/javascript">
    ...
    <script>
        ...
        function addQts(type,cible){ 
            ...
            if (type=="QRO") {
                    var qro_next=qro+1;
                contenu=contenu+'<div class="card-body m-0 p-0 mt-3">	<div class="row form-goup">		<div class="col-md-10 bg-gradient-blue ml-5">	<label for="num_qro'+qro+'" class="col-form-label">{{ __("Question N") }}<sup>o</sup>'+i+'</label> 	</div>	<div class="col-md-4 m-1"><input hidden id="num_qro'+i+'" type="text" class="form-control" name="type_qst'+i+'" value="qro" >	</div>	</div>	<div class="row form-goup">		<div class="col-md-4"> <label for="devoir_qro'+qro+'" class="col-form-label p-0">{{ __("question ") }}</label> </div>	<div class="col-md-7 m-1"> <input id="qst_numero'+i+'" type="text" class="form-control" name="qst_numero'+i+'"  autocomplete="devoir_qro'+qro+'" autofocus>	</div>	</div> <div class="row form-goup">	<div class="col-md-4">	<label for="devoir_rep_qro'+qro+'" class="col-form-label p-0">{{ __("elements reponse") }}</label> </div>	<div class="col-md-7 m-1"> <input autofocus id="devoir_rep_qro'+qro+'" type="text" class="form-control" name="reponse_numero'+i+'"  autocomplete="devoir_rep_qro'+qro+'"></div>	</div>	<div class="row form-goup">	<div class="col-md-4">	<label for="devoir_explication_qro'+qro+'" class="col-form-label p-0">{{ __("explication") }}</label> </div> <div class="col-md-7 m-1"><input id="devoir_explication_qro'+qro+'" type="text" class="form-control" name="explication'+i+'"  autocomplete="devoir_explication_qro'+qro+'"></div>	</div></div>      </div><div class="" id="QRO_contenant'+qro_next+'">';
                    qro++;
            }
            if (type=="VF") {
                contenu=contenu+'<div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="form-group">Question '+i+' <devoiran style="color:red">*</devoiran><textarea name="question_'+i+'" class="form-control" placeholder="saisissez la question ici"></textarea></div> <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><div class="form-group-inner"><div class="row"><div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">Vrai: </div><div class="col-lg-1 col-md-1 col-sm-1 col-xs-12"><input name="reponse_'+i+'" value="VRAI" type="radio"></div></div></div><div class="form-group-inner"><div class="row"><div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">Faux: </div><div class="col-lg-1 col-md-1 col-sm-1 col-xs-12"><input name="reponse_'+i+'" value="FAUX" type="radio"></div></div></div></div><div class="col-lg-7 col-md-7 col-sm-7 col-xs-12"><div class="form-group">Commentaire<textarea  class="form-control" name="com_'+i+'"  placeholder="commenter la question après le choix de la réponse"></textarea></div></div><input type="text" name="typeQst_'+i+'" class="hidden" value="VF"></div></div><br><br>';
                
            }
            if (type=="QRU") {
                var qru_next=qru+1;
                contenu=contenu+'<div class="card-body m-0 p-0 mt-3">  <div class="row form-goup">   <div class="col-md-10 bg-gradient-blue ml-5"><label for="num_qru'+qru+'" class="col-form-label p-0">{{ __("Question N ") }}<sup>o</sup>:'+i+'</label>  </div>	<div class="col-md-4 m-1">	<input hidden id="num_qru'+qru+'" type="text" class="form-control" name="type_qst'+i+'" value="qru"></div>	</div>	<div class="row form-goup">	<div class="col-md-4">	<label for="devoir_qru'+qru+'" class="col-form-label p-0">{{ __("question ") }}</label> </div>	<div class="col-md-7 m-1"> <input id="qst_numero'+i+'" type="text" class="form-control" name="qst_numero'+i+'"  autocomplete="devoir_qru'+qru+'" autofocus>	</div>	</div>	<div class="row form-goup">	<div class="col-md-4"><label for="devoir_rep_qru'+qru+'" class="col-form-label p-0">{{ __("reponse") }}</label>  </div><div class="col-md-7 m-1"><input autofocus id="devoir_rep_qru'+qru+'" type="text" class="form-control" name="reponse_numero'+i+'" autocomplete="devoir_rep_qru'+qru+'">	</div></div><div class="row form-goup">	<div class="col-md-4"><label for="devoir_explication_qru'+qru+'" class="col-form-label p-0">{{ __("explication") }}</label> 	</div>	<div class="col-md-7 m-1"><input id="devoir_explication_qru'+qru+'" type="text" class="form-control" name="explication'+i+'"  autocomplete="devoir_explication_qru'+qru+'"></div>	</div></div>                <div><div class="" id="QRU_contenant_MR'+qru+'"><div class="" id="QRU_contenant_MR'+qru+mr+'"></div></div>	<div class="mb-1 mt-1 text-right pr-5 add_MR_qru'+qru+'" id="QRU_MR_link"><a href="#QRU_MR_link" class="btn btn-info p-1 m-1"> ajouter mauvaise reponse</a>	</div></div>                    </div><div class="" id="QRU_contenant'+qru_next+'">';
                    qru++;
            }
        ...
        $(document).ready(function(){
	      	...
	      	$(".question").hide();
	      	$(".confirmation").hide();
            $('.add_devoir_question').click(function(){
                $test=$(this).hide();
                $('.question').show();
                $('.confirmation').show();
            ...
            $('.add_devoir_qro').click(function(){
                addQts('QRO','QRO_contenant'+qro);
            });
            $('.add_devoir_qru').click(function(){
                mr=1;
