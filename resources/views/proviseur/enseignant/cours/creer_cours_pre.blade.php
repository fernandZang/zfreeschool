...
<div class="container">
    <div class="bg-olive row font-weight-bold text-center ">
        <div class="col border-right border-red p-2 bg-gradient-green">Prerequis </div>
            ...
            <div class="m-2">
                ...
                <div class="col-md-12 p-0 m-0">
                    <div class="row col-md-12 p-0 m-0">
                        <form class="m-0 p-0" method="POST" action="{{route('creer.cours.sp')}}">
                            @csrf
                            <div id="nbr"></div>
                            <div class="form-group col-md-11 ml-4">    
                                <div class="col-md-11 ml-5 mr-0">
                                    <textarea  class="contexte" name="contexte_pre" autofocus></textarea>                                
                                </div>
                                <div class="mb-1 mt-1 text-right pr-5 add_pre_question"><a href="#" class="btn btn-info p-1 m-1">ajouter les questions</a></div>
                            </div>
                            <div class="mt-2 row question">
                                <div class="col-md-6 col card-body border p-0 mb-0" >
                                    ...
                                    <div class="card-body m-0 p-0 mt-3">
                                        ...
                                        <div class="mb-1 mt-1 text-right pr-5 add_pre_qro" id="QRO_contenant_link"><a href="#QRO_contenant_link" class="btn btn-info p-1 m-1"> ajouter QRO</a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col card-body border p-0 mb-0">
                                    ...
                                    <div class="card-body m-0 mt-3 p-0">
                                        ...
                                        <div>
                                            <div class="mb-1 mt-1 text-right pr-5 add_pre_qru" id="QRU_contenant_link">
...
<script type="text/javascript">
    ...
    <script>
        ...
        function addQts(type,cible){ 
            ...
            if (type=="QRO") {
                    var qro_next=qro+1;
                contenu=contenu+'<div class="card-body m-0 p-0 mt-3">	<div class="row form-goup">		<div class="col-md-10 bg-gradient-blue ml-5">	<label for="num_qro'+qro+'" class="col-form-label">{{ __("Question N") }}<sup>o</sup>'+i+'</label> 	</div>	<div class="col-md-4 m-1"><input required hidden id="num_qro'+i+'" type="text" class="form-control" name="type_qst'+i+'" value="qro" >	</div>	</div>	<div class="row form-goup">		<div class="col-md-4"> <label for="pre_qro'+qro+'" class="col-form-label p-0">{{ __("question ") }}</label> </div>	<div class="col-md-7 m-1"> <input required id="qst_numero'+i+'" type="text" class="form-control" name="qst_numero'+i+'"  autocomplete="pre_qro'+qro+'" autofocus>	</div>	</div> <div class="row form-goup">	<div class="col-md-4">	<label for="pre_rep_qro'+qro+'" class="col-form-label p-0">{{ __("elements reponse") }}</label> </div>	<div class="col-md-7 m-1"> <input required autofocus id="pre_rep_qro'+qro+'" type="text" class="form-control" name="reponse_numero'+i+'"  autocomplete="pre_rep_qro'+qro+'"></div>	</div>	<div class="row form-goup">	<div class="col-md-4">	<label for="pre_explication_qro'+qro+'" class="col-form-label p-0">{{ __("explication") }}</label> </div> <div class="col-md-7 m-1"><input id="pre_explication_qro'+qro+'" type="text" class="form-control" name="explication'+i+'"  autocomplete="pre_explication_qro'+qro+'"></div>	</div></div>      </div><div class="" id="QRO_contenant'+qro_next+'">';
                    qro++;
            }
            if (type=="VF") {
            ...
            if (type=="QRU") {
                var qru_next=qru+1;
                contenu=contenu+'<div class="card-body m-0 p-0 mt-3">  <div class="row form-goup">   <div class="col-md-10 bg-gradient-blue ml-5"><label for="num_qru'+qru+'" class="col-form-label p-0">{{ __("Question N ") }}<sup>o</sup>:'+i+'</label>  </div>	<div class="col-md-4 m-1">	<input required hidden id="num_qru'+qru+'" type="text" class="form-control" name="type_qst'+i+'" value="qru"></div>	</div>	<div class="row form-goup">	<div class="col-md-4">	<label for="pre_qru'+qru+'" class="col-form-label p-0">{{ __("question ") }}</label> </div>	<div class="col-md-7 m-1"> <input required id="qst_numero'+i+'" type="text" class="form-control" name="qst_numero'+i+'"  autocomplete="pre_qru'+qru+'" autofocus>	</div>	</div>	<div class="row form-goup">	<div class="col-md-4"><label for="pre_rep_qru'+qru+'" class="col-form-label p-0">{{ __("reponse") }}</label>  </div><div class="col-md-7 m-1"><input required autofocus id="pre_rep_qru'+qru+'" type="text" class="form-control" name="reponse_numero'+i+'" autocomplete="pre_rep_qru'+qru+'">	</div></div><div class="row form-goup">	<div class="col-md-4"><label for="pre_explication_qru'+qru+'" class="col-form-label p-0">{{ __("explication") }}</label> 	</div>	<div class="col-md-7 m-1"><input required id="pre_explication_qru'+qru+'" type="text" class="form-control" name="explication'+i+'"  autocomplete="pre_explication_qru'+qru+'"></div>	</div></div>                <div><div class="" id="QRU_contenant_MR'+qru+'"><div class="" id="QRU_contenant_MR'+qru+mr+'"></div></div>	<div class="mb-1 mt-1 text-right pr-5 add_MR_qru'+qru+'" id="QRU_MR_link"><a href="#QRU_MR_link" class="btn btn-info p-1 m-1"> ajouter mauvaise reponse</a>	</div></div>                    </div><div class="" id="QRU_contenant'+qru_next+'">';
                    qru++;
            }
        ...
        $(document).ready(function(){
	      	...
	      	$(".question").hide();
	      	$(".confirmation").hide();
            $('.add_pre_question').click(function(){
                $test=$(this).hide();
                $('.question').show();
                $('.confirmation').show();
            ...
            $('.add_pre_qro').click(function(){
                addQts('QRO','QRO_contenant'+qro);
            });
            $('.add_pre_qru').click(function(){
                mr=1;
