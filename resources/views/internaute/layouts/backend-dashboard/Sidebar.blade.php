...
<aside class="main-sidebar sidebar-dark-primary navbar-navy elevation-4">
  ...
  <a href="index3.html" class="brand-link bg-navy">
    <img src="{{asset('img/icone2.jpg')}}" alt="AdminLTE Logo" class="img-fluid brand-image img-circle elevation-3"
         style="opacity: .6">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('cours')}}" class="nav-link active">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="pages/layout/top-nav-sidebar.html" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>ajouter les Matières dans une classe</p>
              </a>
            </li>
            <li class="nav-item">
